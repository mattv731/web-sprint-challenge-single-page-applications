...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for. It allows you to add nested routes to the app by changing the url without having to change the whole application.
1. How would you explain form validation to someone who has never programmed before? Basically validation makes sure you that you meet certain requirements in order to continue on to the next part.
1. In 1-2 sentences, define end to end testing. End to end testing tests the entire user experience instead of just one or two elements of it.
